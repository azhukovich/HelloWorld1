...
import spring.ConsoleEventLogger;

public class RestExecutor {

	private HttpClient client;
	private String url;
	private ConsoleEventLogger logger=ConsoleEventLogger.getInstance();
	...
	public RestValidator get(String path, HashMap<String, String> headers) {
		...
		try {
			...
			logger.logEvent("Getting rest for path - "+url+path);
			/*
			...
			logger.logEvent("Response is: "+responseString);
			/*
